        ...
        * */
        ...
        public void RefreshData(Day days)
        {
            ...
            * */
            ...
            for (int i = 0; i < (days.Today[0].Accessories.Length) && (counter < 3); i++)
            {
             ...
             * */
            counter = 0;
            for (int i = 0; i < (days.Today[1].Accessories.Length) && (counter < 3); i++)
            {
             ...
             * */
            counter = 0;
            for (int i = 0; i < (days.Today[2].Accessories.Length) && (counter < 3); i++)
            {
